              ...
              <form method="POST" action="{{route('employee.update',$employee->id)}}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" name="name" value="{{ $employee->name }}" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" required placeholder="Enter Name">
                    <small class="text-danger">{{ $errors->first('name') }}</small>
                  </div>
                  <div class="form-group col-md-6">
                    <label for="exampleInputEmail1">Email <span class="text-danger">*</span></label>
                    <input type="email" name="email" value="{{ $employee->email }}" class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" required placeholder="Enter email">
                  ...
                  <div class="row">
                    ...
                    <option value="{{$value}}" @if($employee->designation == $value) selected @endif>{{$key}}</option>
                    @endforeach
                    </select>
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <img src= "/storage/{{ $employee->photo }}" style="width:150px;height:150px /">
